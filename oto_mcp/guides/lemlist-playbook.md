...
| Un export de leads rend une liste **vide** sur une campagne qui en a | Le défaut de lemlist filtre tout ; le connecteur force `state="all"`. Si tu passes `state` toi-même, sache ce que tu filtres. |
