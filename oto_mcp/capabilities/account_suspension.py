...
CAPABILITIES += [
    Capability(
        ...
        description=(
            ...
            "paused. What it LENT (connector accounts, keys lent to peers) stops with "
            "it — borrowers get a named `lender_suspended` refusal — and comes back "
            "unchanged on resume. op=resume (`target`) → lifts the pause; it is the only way back, "
