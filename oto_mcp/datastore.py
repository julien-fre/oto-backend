...
# Les refus : extraits dans `datastore_errors` (#325), ré-importés ici pour que tout
# appelant (`from .datastore import RowNotFound`) reste inchangé.
from .datastore_schema_ops import SchemaOpsMixin
from .datastore_errors import (  # noqa: F401
    InvalidCursor,
    NamespaceExists,
    NamespaceForbidden,
    NamespaceNotFound,
...
# La colonne et ses couches : extraites dans `datastore_columns` (#325), ré-importées
# ici pour que les appelants (et les tests qui les exercent) restent inchangés.
from .datastore_columns import (  # noqa: E402,F401
    _META_COLS,
    _existing_layers,
    _merge_column,
