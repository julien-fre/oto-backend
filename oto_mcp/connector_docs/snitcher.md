...
- « les entreprises SaaS de plus de 200 salariés vues récemment » → `snitcher_organisation(op="search", filters={"operator": "AND", "conditions": [...]})` — filtres booléens imbriquables (equal/contains/in/between/greater_than/less_than_x_units_ago…)
...
- construit depuis le spec OpenAPI officiel (app.snitcher.com/api/docs, 2026-08-23) — pas encore confirmé par un test live avec une vraie clé
