...
- suppression/modification de ressources existantes (projet Rank Tracker, mots-clés suivis, compétiteurs, report Brand Radar) ne sont **pas** exposées — lecture et création seulement, par choix (même parti pris que Silae : une suppression est un acte délibéré, jamais un effet de bord)
