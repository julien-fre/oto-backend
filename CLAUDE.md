...
| `billing.md` | abonnement par org (ADR 0043) : le modèle sans objet subscription Mollie, **le mandat qui naît quelques minutes APRÈS l'encaissement** (une course, pas un échec), les 3 invariants anti-double-débit, les deux files de reprise du runner — et l'incident du 25/08/2026. |
